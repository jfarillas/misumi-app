...
import { ReceivablesTodayService } from './_services/receivables-today.service';
import { Sort } from '@angular/material';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: 'app-receivables-today',
  templateUrl: './receivables-today.component.html',
  styleUrls: ['./receivables-today.component.css']
})
export class ReceivablesTodayComponent implements OnInit {
  ...
  constructor( private receivablesTodayService: ReceivablesTodayService ) { }
  ...
  getSales(): void {
    this.sales = this.receivablesTodayService.getAll(Number(localStorage.getItem('userId'))).then((res: any) => {
      console.log(res);
      // Sorting data
      this.sortedData = res;
